      ...
      <div className="px-4 md:px-8 py-6 max-w-3xl space-y-6">
        ...
        <motion.section initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
          <div className="bg-primary rounded-xl p-4 text-primary-foreground">
            ...
            <p className="text-white/85 text-sm leading-relaxed whitespace-pre-line mb-3">
              {TEAM_TEXT}
            </p>
            ...
            <a
              ...
              className="inline-flex items-center justify-center bg-secondary text-white font-semibold text-sm px-6 py-3 rounded-full hover:bg-secondary/90 active:scale-95 transition-all duration-150 shadow-lg shadow-secondary/30 w-full">
              
              Fancy joining the Carnival Crew?
            </a>
          </div>
        </motion.section>
      </div>
