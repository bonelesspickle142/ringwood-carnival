      ...
      <div className="relative h-[70vh] min-h-[500px]">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-12">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex items-center gap-2 mb-4">
            ...
            <span className="text-secondary font-heading font-bold text-sm tracking-widest uppercase">Carnival Day</span>
          </motion.div>

          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="font-heading text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-2">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="mb-4">
            <p className="text-white/50 text-xs font-heading uppercase tracking-widest mb-2">Supported by</p>
            <LogoCarousel />
          </motion.div>

          {/* Procession Progress (moved below) */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="bg-white/10 backdrop-blur-lg rounded-xl p-4 md:p-5 max-w-2xl border border-white/10">
